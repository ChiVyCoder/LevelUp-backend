...
namespace LevelUp.Migrations
{
    ...
    [Migration("20250609144140_FinalDatabaseSetup")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LevelUp.Models.InternshipCompany", b =>
                {
            ...
            modelBuilder.Entity("LevelUp.Models.InternshipRegistration", b =>
                {
                    ...
                    b.Property<int?>("InternshipCompanyCompanyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InternshipCompanyCompanyId");
            ...
            modelBuilder.Entity("LevelUp.Models.InternshipRegistration", b =>
                {
                    b.HasOne("LevelUp.Models.InternshipCompany", null)
                        .WithMany("InternshipRegistrations")
                        .HasForeignKey("InternshipCompanyCompanyId");

                    b.HasOne("LevelUp.Models.Job", "Job")
                        .WithMany()
                        .HasForeignKey("JobID")
